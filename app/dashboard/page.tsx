...
export default function DashboardPage() {
  ...
  // ── AI new-task flash (driven by global mohir:task-created event) ─────────
  ...
  useEffect(() => {
    ...
    window.addEventListener('mohir:task-created', handler)
    return () => window.removeEventListener('mohir:task-created', handler)
  }, [])
