...
function StatusDot({ status }: { status: SprintTaskStatus }) {
  const s = ST_STATUS[status]
  return (
    <span
      style={{
        display: 'inline-flex',
  ...
  return (
    <div style={{ backgroundColor: C.bg, minHeight: '100vh' }}>
      ...
      >
        ...
        {loading ? (
          <div style={{ height: 14, width: 200, borderRadius: 4, backgroundColor: C.surface }} />
        ) : sprint ? (
          <>
              ...
              >
                ...
                {!isCollapsed && (
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <colgroup>
                      {ST_COLS.map((col, i) => (
                        <col key={i} style={{ width: col.width === undefined ? undefined : col.width }} />
                      ))}
                    </colgroup>
                    ...
                    <tbody>
                      {sprintTasks.map(task => {
                        ...
                        return (
                          <Fragment key={task.id}>
                            <tr
                              style={{ backgroundColor: C.surface, transition: 'background-color 0.08s' }}
                              ...
                              <td style={tdBase}>
                                <div style={{ position: 'relative', display: 'inline-block' }}>
                                  <select
                                    ...
                                    style={{
                                      backgroundColor: ST_STATUS[task.status].bg,
                                      color: ST_STATUS[task.status].text,
                                      border: 'none',
                                      borderRadius: 9999,
                                      fontSize: 11,
                                      fontWeight: 500,
                              ...
                              <td style={{ ...tdBase, padding: '0 8px', textAlign: 'center' }}>
                                <button
                                  ...
                                  style={{
                                    ...
                                    borderRadius: 5,
                                    color: C.muted,
                                    opacity: deletingStId === task.id ? 0.3 : 1,
                                    display: 'flex',
                                    alignItems: 'center',
                                ...
                                >
                                  {entry ? (
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px 24px' }}>
                                      {[
                                        { label: 'Planned (h)', value: displayTime(entry.planned_time) },
                                        { label: 'Actual (h)',  value: displayTime(entry.actual_time)  },
                                        { label: 'Start Date',  value: entry.start_date ?? '—'         },
                                        { label: 'Due Date',    value: entry.due_date   ?? '—'         },
                                      ].map(({ label, value }) => (
                                        <div key={label}>
                                          <p style={{ margin: '0 0 3px', fontSize: 10, fontWeight: 600, color: C.muted, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                                            {label}
                                          </p>
                                          <p style={{ margin: 0, fontSize: 13, color: value === '—' ? C.muted : C.text }}>
                                            {value}
                                          </p>
                                        </div>
                                      ))}
                      ...
                      <tr>
                        <td
                          colSpan={NCOLS}
                          style={{ padding: '8px 16px', backgroundColor: C.bg, borderTop: `1px solid ${C.border}` }}
                        >
                            ...
                            >
                              <input
                                ...
                                style={{
                                  ...
                                  outline: 'none',
                                  fontFamily: 'inherit',
                                  boxShadow: `0 0 0 3px rgba(123,104,238,0.12)`,
                                }}
                              />
                              <div style={{ position: 'relative' }}>
                                <select
                                  ...
                                  style={{
                                    ...
                                    border: `1px solid ${C.border}`,
                                    borderRadius: 6,
                                    color: PRIORITY_CONFIG[addPriority].color,
                                    fontSize: 12,
                                    fontWeight: 500,
                              ...
                              <button
                                ...
                                style={{
                                  backgroundColor: addLoading || !addName.trim() ? C.primaryHover : C.primary,
                                  color: '#fff',
                                  border: 'none',
                                  borderRadius: 6,
                                  fontSize: 12,
